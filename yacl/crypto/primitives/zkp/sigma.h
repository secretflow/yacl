...
#include "yacl/crypto/primitives/zkp/sigma_config.h"
#include "yacl/crypto/primitives/zkp/sigma_owh.h"
...
class SigmaProtocol {
 public:
  ...
  Buffer GeneratorsSerialize() const;

  static MPInt GenChallenge(const std::shared_ptr<EcGroup>& group,
                            const SigmaGenerator& generators,
