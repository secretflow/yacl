...
TEST(ProtocolTest, VOPRFWorks) {
  ...
  std::fill(seed.begin(), seed.end(), 0xa3);
  std::string info = "test key";
  math::MPInt blindness = "0x3338fa65ec36e0290022b48eb562889d8"
