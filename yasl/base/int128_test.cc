...
TEST(Int128Test, Decompose) {
  {
    int128_t v = 1;
    auto parts = yasl::DecomposeInt128(v);
    EXPECT_EQ(v, yasl::MakeInt128(parts.first, parts.second));
  }
  {
    int128_t v = -1;
    auto parts = yasl::DecomposeInt128(v);
  ...
  {
    uint128_t v = 1;
    auto parts = yasl::DecomposeUInt128(v);
    EXPECT_EQ(v, yasl::MakeUint128(parts.first, parts.second));
  }
}
