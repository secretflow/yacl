...
def _com_github_herumi_mcl():
    maybe(
        ...
        strip_prefix = "mcl-1.94",
        sha256 = "290eafbcd37156be4b8c1c083fb5679e094fc503e027c72f9ab22336c0cdc19b",
        type = "tar.gz",
        ...
        urls = ["https://github.com/herumi/mcl/archive/refs/tags/v1.94.tar.gz"],
    )
