...
def _com_github_herumi_mcl():
    maybe(
        ...
        strip_prefix = "mcl-1.92",
        sha256 = "17617397a61ce12246dadae2ab07d807ea3cf79c299a4e4a5506feb594ec2cf4",
        type = "tar.gz",
        ...
        urls = ["https://github.com/herumi/mcl/archive/refs/tags/v1.92.tar.gz"],
    )
