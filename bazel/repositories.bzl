...
def _com_github_dltcollab_sse2neon():
    maybe(
        ...
        sha256 = "b3bb5c07dee12ce4ca60359e2db17994447f3539721d9ba161b890c4c0db0815",
        strip_prefix = "sse2neon-29716df957401e9c357348e9b73c95a38cdcd34f",
        type = "tar.gz",
        urls = [
            "https://github.com/DLTcollab/sse2neon/archive/29716df957401e9c357348e9b73c95a38cdcd34f.tar.gz",
        ],
