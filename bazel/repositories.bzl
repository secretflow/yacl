...
def _org_interconnection():
    maybe(
        ...
        urls = [
            "https://github.com/secretflow/interconnection/archive/e9a64bfe1ae57f358b41790a1bdd82c390dd50da.tar.gz",
        ],
        strip_prefix = "interconnection-e9a64bfe1ae57f358b41790a1bdd82c390dd50da",
        sha256 = "1b8be4bd3f95d180c177b24a6ab3f8477a0e6e917058f8fb1d0013a17d7f5aba",
    )
...
def _com_google_protobuf():
    maybe(
        ...
        type = "tar.gz",
        urls = [
            "https://github.com/protocolbuffers/protobuf/releases/download/v25.2/protobuf-all-3.19.4.tar.gz",
        ],
    )
...
def _com_github_dltcollab_sse2neon():
    maybe(
        ...
        sha256 = "5491c5038a301a6b0ba0531e516568bb50d165d206360f03d8d56558a2490669",
        strip_prefix = "sse2neon-cfaa59fc04fecb117c0a0f3fe9c82dece6f359ad",
        type = "tar.gz",
        urls = [
            "https://github.com/DLTcollab/sse2neon/archive/cfaa59fc04fecb117c0a0f3fe9c82dece6f359ad.tar.gz",
        ],
