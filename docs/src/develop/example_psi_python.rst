...
This is an example of how to use Yacl's ECC api and link to build up a `PSI (Private Set Intersection) <https://en.wikipedia.org/wiki/Private_set_intersection>`_ protocol, and provide a python language binding using `pybind11 <https://github.com/pybind/pybind11>`_. The code of this example is available on `GitHub <https://github.com/secretflow/yacl/tree/main/examples/psi/python>`_.
